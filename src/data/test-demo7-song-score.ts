...
const battlePatterns = [
  [{ offset: 0, midi: 62, duration: 0.5, velocity: 96, accent: 'strong' }, { offset: 0.5, midi: 65, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 1, midi: 62, duration: 0.5, velocity: 94, accent: 'medium' }, { offset: 1.5, midi: 60, duration: 0.5, velocity: 92, accent: 'medium' }, { offset: 2, midi: 62, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 2.5, midi: 65, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 3, midi: 69, duration: 1, velocity: 104, accent: 'strong' }],
  [{ offset: 0, midi: 60, duration: 0.5, velocity: 96, accent: 'strong' }, { offset: 0.5, midi: 64, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 1, midi: 60, duration: 0.5, velocity: 94, accent: 'medium' }, { offset: 1.5, midi: 59, duration: 0.5, velocity: 92, accent: 'medium' }, { offset: 2, midi: 60, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 2.5, midi: 64, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 3, midi: 67, duration: 1, velocity: 104, accent: 'strong' }],
  [{ offset: 0, midi: 58, duration: 0.5, velocity: 96, accent: 'strong' }, { offset: 0.5, midi: 62, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 1, midi: 58, duration: 0.5, velocity: 94, accent: 'medium' }, { offset: 1.5, midi: 57, duration: 0.5, velocity: 92, accent: 'medium' }, { offset: 2, midi: 58, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 2.5, midi: 62, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 3, midi: 65, duration: 1, velocity: 104, accent: 'strong' }],
  [{ offset: 0, midi: 57, duration: 0.5, velocity: 96, accent: 'strong' }, { offset: 0.5, midi: 61, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 1, midi: 57, duration: 0.5, velocity: 94, accent: 'medium' }, { offset: 1.5, midi: 55, duration: 0.5, velocity: 92, accent: 'medium' }, { offset: 2, midi: 57, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 2.5, midi: 61, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 3, midi: 64, duration: 1, velocity: 104, accent: 'strong' }],
  [{ offset: 0, midi: 62, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 0.5, midi: 65, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 1, midi: 69, duration: 0.5, velocity: 104, accent: 'strong' }, { offset: 1.5, midi: 65, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 2, midi: 70, duration: 0.5, velocity: 106, accent: 'strong' }, { offset: 2.5, midi: 69, duration: 0.5, velocity: 102, accent: 'strong' }, { offset: 3, midi: 65, duration: 1, velocity: 98, accent: 'medium' }],
  [{ offset: 0, midi: 60, duration: 0.5, velocity: 96, accent: 'strong' }, { offset: 0.5, midi: 64, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 1, midi: 60, duration: 0.5, velocity: 94, accent: 'medium' }, { offset: 1.5, midi: 57, duration: 0.5, velocity: 92, accent: 'medium' }, { offset: 2, midi: 60, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 2.5, midi: 64, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 3, midi: 67, duration: 1, velocity: 102, accent: 'strong' }],
  [{ offset: 0, midi: 58, duration: 0.5, velocity: 94, accent: 'strong' }, { offset: 0.5, midi: 62, duration: 0.5, velocity: 96, accent: 'strong' }, { offset: 1, midi: 58, duration: 0.5, velocity: 92, accent: 'medium' }, { offset: 1.5, midi: 55, duration: 0.5, velocity: 90, accent: 'medium' }, { offset: 2, midi: 58, duration: 0.5, velocity: 96, accent: 'strong' }, { offset: 2.5, midi: 62, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 3, midi: 65, duration: 1, velocity: 100, accent: 'strong' }],
  [{ offset: 0, midi: 57, duration: 0.5, velocity: 96, accent: 'strong' }, { offset: 0.5, midi: 60, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 1, midi: 57, duration: 0.5, velocity: 94, accent: 'medium' }, { offset: 1.5, midi: 55, duration: 0.5, velocity: 92, accent: 'medium' }, { offset: 2, midi: 57, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 2.5, midi: 60, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 3, midi: 64, duration: 1, velocity: 102, accent: 'strong' }],
  [{ offset: 0, midi: 65, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 0.5, midi: 69, duration: 0.5, velocity: 102, accent: 'strong' }, { offset: 1, midi: 65, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 1.5, midi: 62, duration: 0.5, velocity: 96, accent: 'medium' }, { offset: 2, midi: 65, duration: 0.5, velocity: 102, accent: 'strong' }, { offset: 2.5, midi: 69, duration: 0.5, velocity: 104, accent: 'strong' }, { offset: 3, midi: 72, duration: 1, velocity: 108, accent: 'strong' }],
  [{ offset: 0, midi: 64, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 0.5, midi: 67, duration: 0.5, velocity: 102, accent: 'strong' }, { offset: 1, midi: 64, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 1.5, midi: 60, duration: 0.5, velocity: 96, accent: 'medium' }, { offset: 2, midi: 64, duration: 0.5, velocity: 102, accent: 'strong' }, { offset: 2.5, midi: 67, duration: 0.5, velocity: 104, accent: 'strong' }, { offset: 3, midi: 71, duration: 1, velocity: 108, accent: 'strong' }],
  [{ offset: 0, midi: 62, duration: 0.5, velocity: 98, accent: 'strong' }, { offset: 0.5, midi: 65, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 1, midi: 62, duration: 0.5, velocity: 96, accent: 'medium' }, { offset: 1.5, midi: 57, duration: 0.5, velocity: 92, accent: 'medium' }, { offset: 2, midi: 62, duration: 0.5, velocity: 100, accent: 'strong' }, { offset: 2.5, midi: 65, duration: 0.5, velocity: 102, accent: 'strong' }, { offset: 3, midi: 69, duration: 1, velocity: 104, accent: 'strong' }],
  [{ offset: 0, midi: 65, duration: 2, velocity: 100, accent: 'strong' }, { offset: 2, midi: 72, duration: 1, velocity: 106, accent: 'strong' }, { offset: 3, midi: 69, duration: 1, velocity: 102, accent: 'strong' }],
];
...
const warLayerEvents = [
  ...
  [25, 'battle', [{ offset: 0, midi: 50, duration: 2, velocity: 78, accent: 'medium' }, { offset: 2, midi: 57, duration: 2, velocity: 82, accent: 'strong' }]],
  [26, 'battle', [{ offset: 0, midi: 48, duration: 2, velocity: 78, accent: 'medium' }, { offset: 2, midi: 55, duration: 2, velocity: 82, accent: 'strong' }]],
  [27, 'battle', [{ offset: 0, midi: 46, duration: 2, velocity: 78, accent: 'medium' }, { offset: 2, midi: 53, duration: 2, velocity: 82, accent: 'strong' }]],
  [28, 'battle', [{ offset: 0, midi: 45, duration: 4, velocity: 84, accent: 'strong' }]],
  [29, 'battle', [{ offset: 0, midi: 50, duration: 2, velocity: 80, accent: 'strong' }, { offset: 2, midi: 57, duration: 2, velocity: 84, accent: 'strong' }]],
  [30, 'battle', [{ offset: 0, midi: 48, duration: 2, velocity: 80, accent: 'strong' }, { offset: 2, midi: 55, duration: 2, velocity: 84, accent: 'strong' }]],
  [31, 'battle', [{ offset: 0, midi: 46, duration: 2, velocity: 80, accent: 'strong' }, { offset: 2, midi: 53, duration: 2, velocity: 84, accent: 'strong' }]],
  [32, 'battle', [{ offset: 0, midi: 45, duration: 4, velocity: 86, accent: 'strong' }]],
  [33, 'battle', [{ offset: 0, midi: 57, duration: 2, velocity: 84, accent: 'strong' }, { offset: 2, midi: 62, duration: 2, velocity: 88, accent: 'strong' }]],
  [34, 'battle', [{ offset: 0, midi: 55, duration: 2, velocity: 84, accent: 'strong' }, { offset: 2, midi: 60, duration: 2, velocity: 88, accent: 'strong' }]],
  [35, 'battle', [{ offset: 0, midi: 57, duration: 4, velocity: 90, accent: 'strong' }]],
  [36, 'battle', [{ offset: 0, midi: 50, duration: 4, velocity: 86, accent: 'strong' }]],
...
export const testDemo7SongScore = {
  ...
  meta: {
    ...
    key: 'D minor',
    unitNoteLength: '1/8',
    genre: 'Ancient Frontier Ensemble Demo',
    mood: '边塞 / 风沙 / 低盘推进 / 多乐器搭配',
    tags: ['arrangement-demo', 'frontier', 'ensemble', 'cello', 'flute', 'war-drum', 'instrumental'],
  },
  sections,
  tracks: [
    {
  ...
  annotations: [
    {
      ...
      text: '这版不是只听旋律，而是听分工：钢琴先立轮廓，大提琴把地面撑起来，长笛像风里带出的边声。',
    },
    {
      type: SONG_SCORE_ANNOTATION_TYPE.ARRANGEMENT_HINT,
      targetSectionId: 'march',
      text: '这一段重点听层次：大提琴托底推进，钢琴负责骨架，低鼓只在关键位置把地面敲实。',
    },
    {
      type: SONG_SCORE_ANNOTATION_TYPE.HOOK_HINT,
      targetSectionId: 'horn',
      text: '这里让长笛先承担“远处边声”的线条，不追求真号角，而是先验证钢琴与吹管副线能不能自然配起来。',
    },
    {
      type: SONG_SCORE_ANNOTATION_TYPE.HOOK_HINT,
      targetSectionId: 'battle',
      text: '高潮先拿来做多轨试听：低鼓给冲击，大提琴给压力，钢琴保留清晰轮廓，长笛只做短促回应，重点不是最猛，而是彼此别打架。',
    },
    {
      type: SONG_SCORE_ANNOTATION_TYPE.ARRANGEMENT_HINT,
    ...
    },
    {
      ...
      text: '尾段回到更清楚的搭配关系：钢琴收束旋律，大提琴维持余压，长笛把空气和边声留在最后。',
    },
  ],
  renderHints: {
    defaultInstruments: {
  ...
  sourceFormat: 'story',
  sourceText: '用于验证多轨配器的边塞器乐 demo：钢琴主线、大提琴托底、长笛回应，先看不同乐器能否自然搭起来。',
};
